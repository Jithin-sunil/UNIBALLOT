            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Principal</p>
                </div>
              </a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="Batch.php">Batch</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="ElectionTeacher.php">
                <span class="icon-bg"><i class="mdi mdi-format-list-bulleted menu-icon"></i></span>
                <span class="menu-title">ElectionTeacher</span>
              </a>
            </li>
            <li class="nav-item">
              <!-- <a class="nav-link" href="AssignElectionTeacher.php">
                <span class="icon-bg"><i class="mdi mdi-chart-bar menu-icon"></i></span>
                <span class="menu-title">Assign Election Teacher</span>
              </a> -->
            </li>
            <li class="nav-item">
              <a class="nav-link" href="ShowResult.php">
                  ...
                  <div>
                    <div class="d-flex align-items-center">
                      <div class="sidebar-profile-img">
                        <img src="../Assets/Template/Admin/assets/images/faces/thomas.png" alt="image" height="40">
                      </div>
