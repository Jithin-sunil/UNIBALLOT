              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="../Assets/Template/Admin/assets/images/faces/face4.jpg" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="../Assets/Template/Admin/assets/images/faces/face2.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="../Assets/Template/Admin/assets/images/faces/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="VoterVerification.php">VoterVerification</a></li>
                  <li class="nav-item"> <a class="nav-link" href="CandidateVerification.php">CandidateVerification</a></li>
                  <li class="nav-item"> <a class="nav-link" href="VoteVerification.php">VoteVerification</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="ViewAssigned.php">
                <span class="icon-bg"><i class="mdi mdi-contacts menu-icon"></i></span>
                <span class="menu-title">ViewAssigned</span>
              </a>
            </li>
            ...
            <li class="nav-item sidebar-user-actions">
              <div class="sidebar-user-menu">
                <!-- <a href="MyProfile.php" class="nav-link"><i class="mdi mdi-settings menu-icon"></i>
